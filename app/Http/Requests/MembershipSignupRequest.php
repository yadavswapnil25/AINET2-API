...
class MembershipSignupRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'age_group'         => 'required_if:membership_type,Individual|string|in:up to 25,26-30,31-35,36-40,41-45,46-50,Over 50',
            ...
            'area_of_work.*'    => ['string'],
            'other_area_of_work' => ['sometimes', 'nullable', 'string', 'max:255'],
